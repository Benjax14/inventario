...
<head>
    ...
    <link rel="stylesheet" href="./var/www/html/inventario/css/imagen.css">
</head>
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light header-color container-bg">
            <div class="container-fluid ">
                <a class="navbar-brand texto-bar" href="./index.php"><img width="13%" height="13%" src="./lmnts_grfcs/queso.png">  Panel administrativo</a>
